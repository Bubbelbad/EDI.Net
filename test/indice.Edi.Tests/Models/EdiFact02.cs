...
namespace indice.Edi.Tests.Models.EdiFact02;
...
public class DTM
{
    [EdiValue("n..3", Path = "DTM/0/0")]
    public int ID { get; set; }
    [EdiValue("an..12", Path = "DTM/0/1", Format = "yyyyMMddHHmm")]
    public DateTime DateTime { get; set; }
    [EdiValue("n3", Path = "DTM/0/2")]
...
{
    [EdiValue("an..3", Path = "DTM/0/0")]
    public int? ID { get; set; }
    [EdiValue("n..1", Path = "DTM/0/1")]
...
{
    [EdiValue("an..1", Path = "LIN/2/0")]
    public string Number { get; set; }

    [EdiValue("n..3", Path = "LIN/2/1")]
    public string Type { get; set; }

    [EdiValue("n..3", Path = "LIN/2/2")]
    public string CodeListQualifier { get; set; }

    [EdiValue("n..3", Path = "LIN/2/3")]
...
public class NAD
{
    [EdiValue("an..3", Path = "NAD/0/0")]
    public string PartyQualifier { get; set; }

    [EdiValue("an..35", Path = "NAD/1/0")]
    public string PartyId { get; set; }

    [EdiValue("an..3", Path = "NAD/1/2")]
...
{
    [EdiValue("an..4", Mandatory = true, Path = "UNB/0")]
    public string SyntaxIdentifier { get; set; }

    [EdiValue("n..1", Path = "UNB/0/1", Mandatory = true)]
    public int SyntaxVersion { get; set; }

    [EdiValue("an..35", Path = "UNB/1/0", Mandatory = true)]
    public string SenderId { get; set; }
    [EdiValue("an..4", Path = "UNB/1/1", Mandatory = true)]
    public string PartnerIDCodeQualifier { get; set; }
    [EdiValue("an..14", Path = "UNB/1/2", Mandatory = false)]
    public string ReverseRoutingAddress { get; set; }

    [EdiValue("an..35", Path = "UNB/2/0", Mandatory = true)]
    public string RecipientId { get; set; }

    [EdiValue("an..4", Path = "UNB/2/1", Mandatory = true)]
    public string ParterIDCode { get; set; }
    [EdiValue("an..14", Path = "UNB/2/2", Mandatory = false)]
    public string RoutingAddress { get; set; }

    [EdiValue("n..6", Path = "UNB/3/0", Format = "ddMMyy", Description = "Date of Preparation")]
    [EdiValue("n..4", Path = "UNB/3/1", Format = "HHmm", Description = "Time or Prep")]
    public DateTime DateOfPreparation { get; set; }

    [EdiValue("an..14", Path = "UNB/4", Mandatory = true)]
    public string ControlRef { get; set; }

    [EdiValue("n..1", Path = "UNB/8", Mandatory = false)]
    public int AckRequest { get; set; }

    public Quote QuoteMessage { get; set; }

    [EdiValue("an..1", Path = "UNZ/0")]
    public int TrailerControlCount { get; set; }

    [EdiValue("an..14", Path = "UNZ/1")]
...
public class Quote
{
    ...
    [EdiValue("an..14", Path = "UNH/0/0")]
    public string MessageRef { get; set; }


    [EdiValue("an..6", Path = "UNH/1/0")]
    public string MessageType { get; set; }

    [EdiValue("an..3", Path = "UNH/1/1")]
    public string Version { get; set; }

    [EdiValue("an..3", Path = "UNH/1/2")]
    public string ReleaseNumber { get; set; }

    [EdiValue("an..2", Path = "UNH/1/3")]
    public string ControllingAgency { get; set; }

    [EdiValue("an..6", Path = "UNH/1/4")]
    public string AssociationAssignedCode { get; set; }

    [EdiValue("an..35", Path = "UNH/2/0")]
    public string CommonAccessRef { get; set; }

    [EdiValue("an..3", Path = "BGM/0/0")]
    public string MessageName { get; set; }

    [EdiValue("an..35", Path = "BGM/1/0")]
    public string DocumentNumber { get; set; }

    [EdiValue("an..3", Path = "BGM/2/0", Mandatory = false)]
    public string MessageFunction { get; set; }

    [EdiValue("an..3", Path = "BGM/3/0")]
...
{
    [EdiValue("an..1", Path = "LIN/0/0")]
    public int LineNumber { get; set; }

    [EdiValue("n..3", Path = "LIN/1/0")]
...
public class Price
{
    [EdiValue("an..3", Path = "PRI/0/0")]
    public string Code { get; set; }

    [EdiValue("an..15", Path = "PRI/0/1")]
    public decimal? Amount { get; set; }

    [EdiValue("an..3", Path = "PRI/0/2")]
    public string Type { get; set; }
}
...
public class Range
{
    [EdiValue("an..3", Path = "RNG/0/0")]
    public string MeasurementUnitCode { get; set; }

    [EdiValue("an..18", Path = "RNG/1/0")]
    public decimal? Minimum { get; set; }

    [EdiValue("an..18", Path = "RNG/1/1")]
