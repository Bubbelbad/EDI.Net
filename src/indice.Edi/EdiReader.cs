...
public abstract class EdiReader : IDisposable
{
    ...
    private string GetCurrentPath() {
        ...
        IEnumerable<EdiPosition> positions = (!startingSegment)
            ? _stack
            : _stack.Concat([_currentPosition]);
    ...
    protected void SetToken(EdiToken newToken) => SetToken(newToken, null, true);
    ...
    protected void SetToken(EdiToken newToken, object value) => SetToken(newToken, value, true);
    ...
    private void SetFinished() => _currentState = State.Finished;
