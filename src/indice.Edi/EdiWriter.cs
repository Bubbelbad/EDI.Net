...
public abstract class EdiWriter : IDisposable
{
    ...
    [
        ...
        /* SegmentStart                 */[State.Segment,         State.Segment,      State.Error,      State.Segment,    State.Segment,     State.Segment,     State.Error, State.Error],
        /* SegmentName                  */[State.SegmentName,     State.SegmentName,  State.SegmentName,State.SegmentName,State.SegmentName, State.SegmentName, State.Error, State.Error],
        /* ElementStart                 */[State.Error,           State.Error,        State.Error,      State.Element,    State.Element,     State.Element,     State.Error, State.Error],
        /* ComponentStart               */[State.Error,           State.Component,    State.Error,      State.Component,  State.Component,   State.Component,   State.Error, State.Error],
        /* Value (this will be copied)  */[State.Error,           State.Value,        State.Error,      State.Value,      State.Value,       State.Value,       State.Error, State.Error]
    ];
    ...
    public string Path {
        get {
            ...
            return EdiPosition.BuildPath(current != null ? stack.Concat([current.Value]) : _stack);
        }
    }
    ...
    private EdiContainerType Peek() => _currentPosition.Type;
    ...
    /// </summary>
    public virtual void Close() => AutoCompleteAll();
    ...
    public void WriteToken(EdiReader reader) => WriteToken(reader, true);
    ...
    /// </summary>
    /// <param name="token">The <see cref="EdiToken"/> to write.</param>
    public void WriteToken(EdiToken token) => WriteToken(token, null);
    ...
    private void AutoCompleteAll() => AutoCompleteClose(EdiContainerType.None);
    ...
    /// Writes a null value.
    /// </summary>
    public virtual void WriteNull() => InternalWriteValue(EdiToken.Null);

    /// <summary>
    /// Writes raw EDI fragment without changing the writer's state.
    /// </summary>
    /// <param name="fragment">A raw EDI fragment to write.</param>
    public virtual void WriteRaw(string fragment) => InternalWriteRaw();
    ...
    public virtual void WriteValue(bool value) => InternalWriteValue(EdiToken.Boolean);
    ...
    public virtual void WriteValue(char value) => InternalWriteValue(EdiToken.String);

    /// <summary>
    /// Writes a <see cref="Byte"/> value.
    /// </summary>
    /// <param name="value">The <see cref="Byte"/> value to write.</param>
    public virtual void WriteValue(byte value) => InternalWriteValue(EdiToken.Integer);
    ...
    public virtual void WriteValue(DateTime value, string format) => InternalWriteValue(EdiToken.Date);
    ...
    /// <param name="format"></param>
    public virtual void WriteValue(DateTimeOffset value, string format) => InternalWriteValue(EdiToken.Date);

    /// <summary>
    /// Writes a <see cref="Guid"/> value.
    /// </summary>
    /// <param name="value">The <see cref="Guid"/> value to write.</param>
    public virtual void WriteValue(Guid value) => InternalWriteValue(EdiToken.String);

    /// <summary>
    /// Writes a <see cref="TimeSpan"/> value.
    /// </summary>
    /// <param name="value">The <see cref="TimeSpan"/> value to write.</param>
    public virtual void WriteValue(TimeSpan value) => InternalWriteValue(EdiToken.String);
    ...
    public virtual void WriteValue(object value) => WriteValue(value, null, null);
    ...
    private static EdiWriterException CreateUnsupportedTypeException(EdiWriter writer, object value) => EdiWriterException.Create(writer, "Unsupported type: {0}. Use the EdiSerializer class to get the object's EDI representation.".FormatWith(CultureInfo.InvariantCulture, value.GetType()), null);
